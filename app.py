...
def predict():
    ...
    if output==1:
        return render_template('I.html', prediction_text="successfull movie")
    else:
        return render_template('I.html', prediction_text="not a successfull movie")
    
    return render_template('I.html', prediction_text='{}'.format(output))
